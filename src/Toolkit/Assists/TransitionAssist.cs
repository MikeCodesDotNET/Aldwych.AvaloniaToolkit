...
namespace Aldwych.AvaloniaToolkit.Assists
{
    public static class TransitionAssist
    {
        ...
        public static readonly AvaloniaProperty<bool> DisableTransitionsProperty = 
            AvaloniaProperty.RegisterAttached<AvaloniaObject, bool>("DisableTransitions", typeof(TransitionAssist), false, true, BindingMode.TwoWay);
