...
{  
    public class Frame : ContentControl
    {
        ...
        public bool Navigate(object vm, NavigationTransitionInfo infoOverride = null)
        {
            return NavigateCore(new PageStackEntry(vm.GetType(), null, infoOverride), NavigationMode.New);
        }
